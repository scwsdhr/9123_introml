...
{\color{incolor}In [{\color{incolor}9}]:} \PY{c+c1}{\PYZsh{} TODO}
        ...
        \PY{n}{plt}\PY{o}{.}\PY{n}{plot}\PY{p}{(}\PY{n}{np}\PY{o}{.}\PY{n}{array}\PY{p}{(}\PY{n+nb}{range}\PY{p}{(}\PY{n+nb}{len}\PY{p}{(}\PY{n}{yi}\PY{p}{)}\PY{p}{)}\PY{p}{)}\PY{o}{/}\PY{n}{sr}\PY{o}{*}\PY{l+m+mi}{1000}\PY{p}{,} \PY{n}{yi}\PY{p}{,} \PY{n}{label}\PY{o}{=}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Original samples}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
        \PY{n}{plt}\PY{o}{.}\PY{n}{plot}\PY{p}{(}\PY{n}{np}\PY{o}{.}\PY{n}{array}\PY{p}{(}\PY{n+nb}{range}\PY{p}{(}\PY{n+nb}{len}\PY{p}{(}\PY{n}{yi}\PY{p}{)}\PY{p}{)}\PY{p}{)}\PY{o}{/}\PY{n}{sr}\PY{o}{*}\PY{l+m+mi}{1000}\PY{p}{,} \PY{n}{audio\PYZus{}fn}\PY{o}{.}\PY{n}{yhati}\PY{p}{,} \PY{n}{label}\PY{o}{=}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Estimated samples}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
        \PY{n}{plt}\PY{o}{.}\PY{n}{xlabel}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Time(ms)}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
        \PY{n}{plt}\PY{o}{.}\PY{n}{ylabel}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Amplitude}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
...
{\color{incolor}In [{\color{incolor}11}]:} \PY{c+c1}{\PYZsh{} TODO}
         \PY{n}{freq0\PYZus{}0} \PY{o}{=} \PY{n}{freq0}\PY{p}{[}\PY{l+m+mi}{20}\PY{p}{]}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
f0\_min=130.000000 midi=47.892097
...
The frequency does not exactly lie on a note since the pitch in a viola
bends around the note.
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
Final estimated frequency: 200.000000
